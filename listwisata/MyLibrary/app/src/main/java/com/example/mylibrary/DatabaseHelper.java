...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private  static final String CREATE_TABLE_STUDENT = "" + "CREATE TABLE "+TABLE_STUDENT+"("+KEY_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, " +KEY_FIRSTNAME+" TEXT );";
    ...
    public long addStudenDetail (String student) {
